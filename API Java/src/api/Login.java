...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Login_candidato objcandidato = new Login_candidato();
            objcandidato.setCpf(Cpf);
            objcandidato.setSenha(Senha);
                
            CandidatoDAO objcandidatodao = new CandidatoDAO();
            objcandidatodao.LoginCandidato(objcandidato);
            ResultSet rs = objcandidatodao.LoginCandidato(objcandidato);
            
            if (objcandidatodao.next()){
